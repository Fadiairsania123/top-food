                            ...
                            @foreach ($data as $key => $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn-success btn btn-sm button"
                                            href="{{ route('transaction.detail', $item->id) }}">Detail</a>
                                        @if ($item->status == 'DIKIRIM' && $item->value == null) <a class="d-block mt-1 btn-sm btn-primary btn button"
                                        href="{{ route('pesanan.diterima',$item->id) }}">Pesanan diterima</a>@endif
                                        @if ($item->status == 'SELESAI' && $item->value == null)
                                            <a class="btn-primary d-block mt-1 btn btn-sm button rating"
