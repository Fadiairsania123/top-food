            ...
            <div class="container">
                <div class="row">
                    ...
                    <a href="{{ route('transaction') }}" class="btn btn-success button">Back</a>
                        <form method="POST" action="{{ route('rating.update') }}" id="formRating" name="formRating">
                            @csrf
                        <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="rating-wrapper">
                                            ...
                                            <!-- star 5 -->
                                            <input type="radio" class="rating" data-id="{{ $item->menu->id }}" id="5-star-rating-{{ $item->menu->id }}" name="star_rating_{{ $item->menu->id }}" value="5">
                                            <label for="5-star-rating-{{ $item->menu->id }}" class="star-rating">
                                                <i class="fas fa-star fa-xs"></i>
                                            </label>
                
                                            <!-- star 4 -->
                                            <input type="radio" class="rating" data-id="{{ $item->menu->id }}" id="4-star-rating-{{ $item->menu->id }}" name="star_rating_{{ $item->menu->id }}" value="4">
                                            <label for="4-star-rating-{{ $item->menu->id }}" class="star-rating star">
                                                <i class="fas fa-star fa-xs"></i>
                                            </label>
                
                                            <!-- star 3 -->
                                            <input type="radio" class="rating" data-id="{{ $item->menu->id }}" id="3-star-rating-{{ $item->menu->id }}" name="star_rating_{{ $item->menu->id }}" value="3">
                                            <label for="3-star-rating-{{ $item->menu->id }}" class="star-rating star">
                                                <i class="fas fa-star fa-xs"></i>
                                            </label>
                
                                            <!-- star 2 -->
                                            <input type="radio" class="rating" data-id="{{ $item->menu->id }}" id="2-star-rating-{{ $item->menu->id }}" name="star_rating_{{ $item->menu->id }}" value="2">
                                            <label for="2-star-rating-{{ $item->menu->id }}" class="star-rating star">
                                                <i class="fas fa-star fa-xs"></i>
                                            </label>
                
                                            <!-- star 1 -->
                                            <input type="radio" class="rating" data-id="{{ $item->menu->id }}" id="1-star-rating-{{ $item->menu->id }}" name="star_rating_{{ $item->menu->id }}" value="1">
                                    ...
                                    <div style="width: inherit;height: 200px;display: grid; place-content: center">
                                        <input type="hidden" name="id_transaction[]" value="{{$item->id_transaction}}"/>
                                        <input type="hidden" name="id[]" value="{{$item->menu->id}}"/>
